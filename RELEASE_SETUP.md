...
2. **Create API tokens** for each project:
   ...
   - Click "Add API token"
   - Name: `pixie-examples-github-actions`
   ...
   - You can use the same token for both repos or create separate tokens
...
(Repeat for pixie-sdk-py if using separate tokens)
...
1. Go to the Actions tab: https://github.com/yiouli/pixie-examples/actions
...
1. **New tag created**: Check https://github.com/yiouli/pixie-examples/tags

2. **Package published**: Check https://test.pypi.org/project/pixie-examples/

3. **GitHub Release created**: Check https://github.com/yiouli/pixie-examples/releases

## Testing Installation from TestPyPI

To test installing your package from TestPyPI:
